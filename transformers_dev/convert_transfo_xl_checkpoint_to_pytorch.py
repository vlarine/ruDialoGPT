...
import transformers_dev.tokenization_transfo_xl as data_utils
from transformers_dev.modeling_transfo_xl import (CONFIG_NAME,
                                                         WEIGHTS_NAME,
                                                         TransfoXLConfig,
                                                         TransfoXLLMHeadModel,
                                                         load_tf_weights_in_transfo_xl)
from transformers_dev.tokenization_transfo_xl import (CORPUS_NAME,
                                                             VOCAB_NAME)
